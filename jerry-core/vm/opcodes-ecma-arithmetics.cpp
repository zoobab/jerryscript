...
opfunc_addition (vm_instr_t opdata, /**< operation data */
                 vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.addition.dst;
  const vm_idx_t left_var_idx = opdata.data.addition.var_left;
  const vm_idx_t right_var_idx = opdata.data.addition.var_right;
 ...
 */
ecma_completion_value_t
opfunc_substraction (vm_instr_t opdata, /**< operation data */
                     vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.substraction.dst;
  const vm_idx_t left_var_idx = opdata.data.substraction.var_left;
  const vm_idx_t right_var_idx = opdata.data.substraction.var_right;
 ...
 */
ecma_completion_value_t
opfunc_multiplication (vm_instr_t opdata, /**< operation data */
                       vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.multiplication.dst;
  const vm_idx_t left_var_idx = opdata.data.multiplication.var_left;
  const vm_idx_t right_var_idx = opdata.data.multiplication.var_right;
 ...
 */
ecma_completion_value_t
opfunc_division (vm_instr_t opdata, /**< operation data */
                 vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.division.dst;
  const vm_idx_t left_var_idx = opdata.data.division.var_left;
  const vm_idx_t right_var_idx = opdata.data.division.var_right;
 ...
 */
ecma_completion_value_t
opfunc_remainder (vm_instr_t opdata, /**< operation data */
                  vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.remainder.dst;
  const vm_idx_t left_var_idx = opdata.data.remainder.var_left;
  const vm_idx_t right_var_idx = opdata.data.remainder.var_right;
 ...
 */
ecma_completion_value_t
opfunc_unary_plus (vm_instr_t opdata, /**< operation data */
                   vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.remainder.dst;
  const vm_idx_t var_idx = opdata.data.remainder.var_left;
 ...
 */
ecma_completion_value_t
opfunc_unary_minus (vm_instr_t opdata, /**< operation data */
                    vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.remainder.dst;
  const vm_idx_t var_idx = opdata.data.remainder.var_left;
