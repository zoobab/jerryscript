...
opfunc_b_and (vm_instr_t opdata, /**< operation data */
              vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_and.dst;
  const vm_idx_t left_var_idx = opdata.data.b_and.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_and.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_or (vm_instr_t opdata, /**< operation data */
             vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_or.dst;
  const vm_idx_t left_var_idx = opdata.data.b_or.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_or.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_xor (vm_instr_t opdata, /**< operation data */
              vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_xor.dst;
  const vm_idx_t left_var_idx = opdata.data.b_xor.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_xor.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_shift_left (vm_instr_t opdata, /**< operation data */
                     vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_shift_left.dst;
  const vm_idx_t left_var_idx = opdata.data.b_shift_left.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_shift_left.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_shift_right (vm_instr_t opdata, /**< operation data */
                      vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_shift_right.dst;
  const vm_idx_t left_var_idx = opdata.data.b_shift_right.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_shift_right.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_shift_uright (vm_instr_t opdata, /**< operation data */
                      vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_shift_uright.dst;
  const vm_idx_t left_var_idx = opdata.data.b_shift_uright.var_left;
  const vm_idx_t right_var_idx = opdata.data.b_shift_uright.var_right;
 ...
 */
ecma_completion_value_t
opfunc_b_not (vm_instr_t opdata, /**< operation data */
              vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.b_not.dst;
  const vm_idx_t right_var_idx = opdata.data.b_not.var_right;
