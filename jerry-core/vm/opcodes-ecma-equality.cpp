...
{
  const vm_idx_t dst_var_idx = opdata.data.equal_value.dst;
  const vm_idx_t left_var_idx = opdata.data.equal_value.var_left;
  const vm_idx_t right_var_idx = opdata.data.equal_value.var_right;
...
opfunc_not_equal_value (vm_instr_t opdata, /**< operation data */
                        vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.not_equal_value.dst;
  const vm_idx_t left_var_idx = opdata.data.not_equal_value.var_left;
  const vm_idx_t right_var_idx = opdata.data.not_equal_value.var_right;
...
opfunc_equal_value_type (vm_instr_t opdata, /**< operation data */
                         vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.equal_value_type.dst;
  const vm_idx_t left_var_idx = opdata.data.equal_value_type.var_left;
  const vm_idx_t right_var_idx = opdata.data.equal_value_type.var_right;
...
opfunc_not_equal_value_type (vm_instr_t opdata, /**< operation data */
                             vm_frame_ctx_t *frame_ctx_p) /**< interpreter context */
{
  const vm_idx_t dst_var_idx = opdata.data.not_equal_value_type.dst;
  const vm_idx_t left_var_idx = opdata.data.not_equal_value_type.var_left;
  const vm_idx_t right_var_idx = opdata.data.not_equal_value_type.var_right;
