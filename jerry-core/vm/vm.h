...
#define VM_OC_FLAGS_SHIFT 16
#define VM_OC_FLAGS_MASK 0x3
#define VM_OC_FLAGS_VALUE(V) (((V) & VM_OC_FLAGS_MASK) << VM_OC_FLAGS_SHIFT)
#define VM_OC_FLAGS(O) (((O) >> VM_OC_FLAGS_SHIFT) & VM_OC_FLAGS_MASK)

enum {
  VM_OC_FLAGS_BRANCH_IF_FALSE = 0,
  VM_OC_FLAGS_BRANCH_IF_TRUE = 1,
  VM_OC_FLAGS_BRANCH_LOGICAL = 2
};
