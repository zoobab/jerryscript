...
#define RCS_ITERATOR_ACCESS_WRITE 0
#define RCS_ITERATOR_ACCESS_READ  1
#define RCS_ITERATOR_ACCESS_SKIP  2

/**
 * Access type
 */
typedef uint8_t rcs_access_t;
 ...
 */
rcs_iterator_ctx_t
rcs_iterator_create (record_set_t *recordset_p, /**< recordset */
                     record_t *record_p) /**< start record */
{
  rcs_iterator_ctx_t ctx;
  {
 ...
 */
static void
rcs_iterator_access (rcs_iterator_ctx_t *ctx_p, /**< iterator context */
 ...
 */
void
rcs_iterator_read (rcs_iterator_ctx_t *ctx_p, /**< iterator context */
 ...
 */
void
rcs_iterator_write (rcs_iterator_ctx_t *ctx_p, /**< iterator context */
 ...
 */
void
rcs_iterator_skip (rcs_iterator_ctx_t *ctx_p, /**< iterator context */
 ...
 */
void
rcs_iterator_reset (rcs_iterator_ctx_t *ctx_p) /**< iterator context */
{
 ...
 */
bool
rcs_iterator_finished (rcs_iterator_ctx_t *ctx_p) /**< iterator context */
{
