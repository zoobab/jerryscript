...
#define RCS_RECORD_TYPE_FREE                     0
#define RCS_RECORD_TYPE_CHARSET                  1
#define RCS_RECORD_TYPE_MAGIC_STR                2
#define RCS_RECORD_TYPE_MAGIC_STR_EX             3
#define RCS_RECORD_TYPE_NUMBER                   4
 ...
 *  Setters
 */
extern void rcs_record_set_type (record_t *, record_type_t);
extern void rcs_record_set_prev (record_set_t *, record_t *, record_t *);
extern void rcs_record_set_size (record_t *, size_t);
extern void rcs_record_set_alignment_bytes_count (record_t *, size_t);
extern void rcs_record_set_hash (record_t *, lit_string_hash_t);
extern void rcs_record_set_charset (record_set_t *, record_t *, const lit_utf8_byte_t *, lit_utf8_size_t);
extern void rcs_record_set_magic_str_id (record_t *, lit_magic_string_id_t);
extern void rcs_record_set_magic_str_ex_id (record_t *, lit_magic_string_ex_id_t);

/*
 *  Getters
 */
extern record_type_t rcs_record_get_type (record_t *);
extern record_t *rcs_record_get_prev (record_set_t *, record_t *);
extern size_t rcs_record_get_size (record_t *);
extern size_t rcs_header_get_size (record_t *);
extern size_t rcs_record_get_alignment_bytes_count (record_t *);
extern lit_string_hash_t rcs_record_get_hash (record_t *);
extern lit_utf8_size_t rcs_record_get_length (record_t *);
extern lit_utf8_size_t rcs_record_get_charset (record_set_t *, record_t *, const lit_utf8_byte_t *, size_t);
extern lit_magic_string_id_t rcs_record_get_magic_str_id (record_t *);
extern lit_magic_string_ex_id_t rcs_record_get_magic_str_ex_id (record_t *);
extern ecma_number_t rcs_record_get_number (record_set_t *, record_t *);

extern bool rcs_record_is_equal (record_set_t *, record_t *, record_t *);
extern bool rcs_record_is_equal_utf8 (record_set_t *, record_t *, const lit_utf8_byte_t *, lit_utf8_size_t);
