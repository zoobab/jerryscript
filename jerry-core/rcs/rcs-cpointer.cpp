 ...
 */
cpointer_t
rcs_cpointer_compress (record_t *pointer) /**< pointer to compress */
{
  cpointer_t cpointer;
   ...
   * then mem_cpointer_t can't store pointer to the unit, and so, cpointer_t stores
 ...
 */
record_t *
rcs_cpointer_decompress (cpointer_t compressed_pointer) /**< recordset-specific compressed pointer */
{
  ...
  record_t *rec_p = (record_t *) (base_pointer + diff);
 ...
 */
cpointer_t rcs_cpointer_null_cp (void)
{
  cpointer_t cp;
