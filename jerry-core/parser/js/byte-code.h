...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_PUSH_LITERAL, CBC_HAS_LITERAL_ARG, 1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PUSH_TWO_LITERALS, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 2, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PUSH_UNDEFINED, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PUSH_TRUE, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PUSH_FALSE, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PUSH_NULL, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  ...
  CBC_BINARY_OPERATION (CBC_EQUAL, NONE) \
  CBC_BINARY_OPERATION (CBC_NOT_EQUAL, NONE) \
  CBC_BINARY_OPERATION (CBC_STRICT_EQUAL, NONE) \
  CBC_BINARY_OPERATION (CBC_STRICT_NOT_EQUAL, NONE) \
  ...
  \
  /* Call opcodes. */ \
  CBC_OPCODE (CBC_CALL, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_IDENT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_PROP, CBC_HAS_POP_STACK_BYTE_ARG, -2, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_PROP_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_PROP_STRING, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_CALL_PROP_STRING_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  \
