...
#define CBC_UNARY_LVALUE_OPERATION(name, group) \
  ...
  CBC_OPCODE (name ## _IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG, 1, (VM_OC_ ## group) | VM_OC_GET_LITERAL | VM_OC_PUT_STACK | VM_OC_PUT_IDENT) \
  CBC_OPCODE (name ## _IDENT_BLOCK, CBC_HAS_LITERAL_ARG, 0, (VM_OC_ ## group) | VM_OC_GET_LITERAL | VM_OC_PUT_BLOCK | VM_OC_PUT_IDENT)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_UNARY_LVALUE_OPERATION (CBC_DELETE, DELETE) \
