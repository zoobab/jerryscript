...
#define CBC_BINARY_LVALUE_OPERATION(name, group) \
  CBC_OPCODE (name, CBC_NO_FLAG, -3, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_RIGHT_OPERAND_VALUE(VM_OC_OP_STACK)) \
  CBC_OPCODE (name ## _IDENT, CBC_HAS_LITERAL_ARG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_LITERAL) | VM_OC_RIGHT_OPERAND_VALUE(VM_OC_OP_STACK)) \
  CBC_OPCODE (name ## _IDENT_LITERAL, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_LITERAL) | VM_OC_RIGHT_OPERAND_VALUE(VM_OC_OP_LITERAL)) \
...
#define CBC_FORWARD_BRANCH(name, stack, vm_oc) \
  CBC_OPCODE (name, CBC_HAS_BRANCH_ARG | CBC_FORWARD_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_1) | vm_oc) \
  CBC_OPCODE (name ## _2, CBC_HAS_BRANCH_ARG | CBC_FORWARD_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_2) | vm_oc) \
  CBC_OPCODE (name ## _3, CBC_HAS_BRANCH_ARG | CBC_FORWARD_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_3) | vm_oc)

#define CBC_BACKWARD_BRANCH(name, stack, vm_oc) \
  CBC_OPCODE (name, CBC_HAS_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_1) | vm_oc) \
  CBC_OPCODE (name ## _2, CBC_HAS_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_2) | vm_oc) \
  CBC_OPCODE (name ## _3, CBC_HAS_BRANCH_ARG, stack, VM_OC_BRANCH_OPERAND_VALUE(VM_OC_BRANCH_3) | vm_oc)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_FORWARD_BRANCH (CBC_JUMP_FORWARD, 0, VM_OC_GROUP_VALUE(VM_OC_GROUP_JUMP)) \
  CBC_OPCODE (CBC_POP, CBC_NO_FLAG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_POP)) \
  CBC_BACKWARD_BRANCH (CBC_JUMP_BACKWARD, 0, VM_OC_GROUP_VALUE(VM_OC_GROUP_JUMP)) \
  CBC_OPCODE (CBC_POP_BLOCK, CBC_NO_FLAG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_POP)) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_TRUE_FORWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_IF_TRUE)) \
  CBC_OPCODE (CBC_RETURN, CBC_NO_FLAG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_RET) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_BACKWARD_BRANCH (CBC_BRANCH_IF_TRUE_BACKWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_IF_TRUE)) \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_FALSE_FORWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_IF_FALSE)) \
  CBC_OPCODE (CBC_CREATE_OBJECT, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_BACKWARD_BRANCH (CBC_BRANCH_IF_FALSE_BACKWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_IF_FALSE)) \
  CBC_OPCODE (CBC_SET_PROPERTY, CBC_HAS_LITERAL_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_JUMP_FORWARD_EXIT_CONTEXT, 0, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_CREATE_ARRAY, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_TRUE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_LOGICAL | VM_OC_FLAGS_BRANCH_IF_TRUE)) \
  CBC_OPCODE (CBC_ARRAY_APPEND, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_FALSE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF) | VM_OC_FLAGS_VALUE(VM_OC_FLAGS_BRANCH_LOGICAL | VM_OC_FLAGS_BRANCH_IF_FALSE)) \
  CBC_OPCODE (CBC_PUSH_ELISION, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_STRICT_EQUAL, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_STRICT_EQUAL)) \
  \
  /* Basic opcodes. */ \
  CBC_OPCODE (CBC_PUSH_IDENT, CBC_HAS_LITERAL_ARG, 1, VM_OC_GROUP_VALUE(VM_OC_GROUP_PUSH) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_LITERAL) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  ...
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN, ASSIGN) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_ADD, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_SUBTRACT, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_MULTIPLY, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_DIVIDE, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_MODULO, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_LEFT_SHIFT, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_RIGHT_SHIFT, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_UNS_RIGHT_SHIFT, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_BIT_AND, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_BIT_OR, NONE) \
  CBC_BINARY_LVALUE_OPERATION (CBC_ASSIGN_BIT_XOR, NONE) \
  \
...
#define CBC_EXT_OPCODE_LIST \
  ...
  CBC_FORWARD_BRANCH (CBC_EXT_WITH_CREATE_CONTEXT, -1 + PARSER_WITH_CONTEXT_STACK_ALLOCATION, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_EXT_FOR_IN_GET_NEXT, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_EXT_FOR_IN_CREATE_CONTEXT, -1 + PARSER_FOR_IN_CONTEXT_STACK_ALLOCATION, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_EXT_SET_GETTER, CBC_HAS_LITERAL_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_BACKWARD_BRANCH (CBC_EXT_BRANCH_IF_FOR_IN_HAS_NEXT, 0, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_EXT_SET_SETTER, CBC_HAS_LITERAL_ARG, -1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_EXT_TRY_CREATE_CONTEXT, PARSER_TRY_CONTEXT_STACK_ALLOCATION, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_EXT_PUSH_UNDEFINED_BASE, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_EXT_CATCH, 1, VM_OC_OP_NONE) \
  CBC_OPCODE (CBC_EXT_DEBUGGER, CBC_NO_FLAG, 0, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_EXT_FINALLY, 0, VM_OC_OP_NONE) \
  \
  /* Call opcodes. */ \
