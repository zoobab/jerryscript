...
#define CBC_UNARY_LVALUE_OPERATION(name, group, flags) \
  ...
  CBC_OPCODE (name ## _IDENT, CBC_HAS_LITERAL_ARG, 0, (VM_OC_ ## group) | (flags)) \
  CBC_OPCODE (name ## _IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG, 1, (VM_OC_ ## group) | (flags) | VM_OC_PUT_STACK) \
  CBC_OPCODE (name ## _IDENT_BLOCK, CBC_HAS_LITERAL_ARG, 0, (VM_OC_ ## group) | (flags) | VM_OC_PUT_BLOCK)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_SET_PROPERTY, CBC_HAS_LITERAL_ARG, -1, VM_OC_SET_PROPERTY | VM_OC_GET_LITERAL | VM_OC_GET_STACK) \
  ...
  CBC_UNARY_LVALUE_OPERATION (CBC_DELETE, DELETE, 0) \
  CBC_UNARY_LVALUE_OPERATION (CBC_PRE_INCR, PRE_INCR, VM_OC_GET_LITERAL | VM_OC_PUT_IDENT) \
  CBC_UNARY_LVALUE_OPERATION (CBC_PRE_DECR, PRE_DECR, VM_OC_GET_LITERAL | VM_OC_PUT_IDENT) \
  CBC_UNARY_LVALUE_OPERATION (CBC_POST_INCR, POST_INCR, VM_OC_GET_LITERAL | VM_OC_PUT_IDENT) \
  CBC_UNARY_LVALUE_OPERATION (CBC_POST_DECR, POST_DECR, VM_OC_GET_LITERAL | VM_OC_PUT_IDENT) \
  \
  /* Call opcodes. */ \
