...
#define CBC_UNARY_LVALUE_OPERATION(name) \
  ...
  CBC_OPCODE (name ## _PUSH_RESULT, CBC_NO_FLAG, -1, VM_OC_NONE | VM_OC_GET_STACK_STACK | VM_OC_PUT_STACK) \
  CBC_OPCODE (name ## _BLOCK, CBC_NO_FLAG, -2, VM_OC_NONE | VM_OC_GET_STACK_STACK | VM_OC_PUT_BLOCK) \
  CBC_OPCODE (name ## _IDENT, CBC_HAS_LITERAL_ARG, 0, VM_OC_NONE) \
  CBC_OPCODE (name ## _IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG, 1, VM_OC_NONE | VM_OC_PUT_STACK) \
  CBC_OPCODE (name ## _IDENT_BLOCK, CBC_HAS_LITERAL_ARG, 0, VM_OC_NONE | VM_OC_PUT_BLOCK)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_SET_PROPERTY, CBC_HAS_LITERAL_ARG, -1, VM_OC_NONE | VM_OC_GET_STACK) \
  ...
  CBC_OPCODE (CBC_PUSH_THIS_LITERAL, CBC_HAS_LITERAL_ARG, 2, VM_OC_NONE) \
  ...
  CBC_OPCODE (CBC_NEW, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_CALL | VM_OC_GET_BYTE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_NEW0, CBC_NO_FLAG, 0, VM_OC_CALL_N | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_NEW1, CBC_NO_FLAG, -1, VM_OC_CALL_N | VM_OC_PUT_STACK) \
  ...
  CBC_OPCODE (CBC_CALL_EVAL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_CALL | VM_OC_GET_BYTE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL_EVAL_BLOCK, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_CALL | VM_OC_GET_BYTE | VM_OC_PUT_BLOCK) \
  CBC_OPCODE (CBC_CALL_PROP, CBC_HAS_POP_STACK_BYTE_ARG, -3, VM_OC_CALL | VM_OC_GET_BYTE) \
  CBC_OPCODE (CBC_CALL_PROP_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, -2, VM_OC_CALL | VM_OC_GET_BYTE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL_PROP_BLOCK, CBC_HAS_POP_STACK_BYTE_ARG, -3, VM_OC_CALL | VM_OC_GET_BYTE | VM_OC_PUT_BLOCK) \
  ...
  CBC_OPCODE (CBC_CALL0_PROP, CBC_NO_FLAG, -3, VM_OC_CALL_N) \
  CBC_OPCODE (CBC_CALL0_PROP_PUSH_RESULT, CBC_NO_FLAG, -2, VM_OC_CALL_N | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL0_PROP_BLOCK, CBC_NO_FLAG, -3, VM_OC_CALL_N | VM_OC_PUT_BLOCK) \
  ...
  CBC_OPCODE (CBC_CALL1_PROP, CBC_NO_FLAG, -4, VM_OC_CALL_N) \
  CBC_OPCODE (CBC_CALL1_PROP_PUSH_RESULT, CBC_NO_FLAG, -3, VM_OC_CALL_N | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL1_PROP_BLOCK, CBC_NO_FLAG, -4, VM_OC_CALL_N | VM_OC_PUT_BLOCK) \
  ...
  CBC_OPCODE (CBC_CALL2_PROP, CBC_NO_FLAG, -4, VM_OC_CALL_N) \
  CBC_OPCODE (CBC_CALL2_PROP_PUSH_RESULT, CBC_NO_FLAG, -3, VM_OC_CALL_N | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL2_PROP_BLOCK, CBC_NO_FLAG, -4, VM_OC_CALL_N | VM_OC_PUT_BLOCK) \
  \
  ...
  CBC_OPCODE (CBC_ASSIGN_PROP_THIS_LITERAL, CBC_HAS_LITERAL_ARG, -1, VM_OC_NONE | VM_OC_GET_STACK) \
  CBC_OPCODE (CBC_ASSIGN_PROP_THIS_LITERAL_PUSH_RESULT, CBC_HAS_LITERAL_ARG, 0, VM_OC_NONE | VM_OC_GET_STACK | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_ASSIGN_PROP_THIS_LITERAL_BLOCK, CBC_HAS_LITERAL_ARG, -1, VM_OC_NONE | VM_OC_GET_STACK | VM_OC_PUT_BLOCK) \
  \
...
#define CBC_EXT_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_EXT_FOR_IN_GET_NEXT, CBC_NO_FLAG, 1, VM_OC_NONE | VM_OC_PUT_STACK) \
  CBC_FORWARD_BRANCH (CBC_EXT_FOR_IN_CREATE_CONTEXT, -1 + PARSER_FOR_IN_CONTEXT_STACK_ALLOCATION, VM_OC_NONE) \
  CBC_OPCODE (CBC_EXT_SET_GETTER, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, VM_OC_NONE) \
  CBC_BACKWARD_BRANCH (CBC_EXT_BRANCH_IF_FOR_IN_HAS_NEXT, 0, VM_OC_NONE) \
  CBC_OPCODE (CBC_EXT_SET_SETTER, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, VM_OC_NONE) \
