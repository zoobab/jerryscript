...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_CALL_IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 1, VM_OC_GROUP_VALUE(VM_OC_GROUP_CALL) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_BYTE) | VM_OC_RIGHT_OPERAND_VALUE(VM_OC_OP_LITERAL)) \
