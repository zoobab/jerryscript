...
#define CBC_OPCODE_LIST \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_TRUE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK)) \
  CBC_OPCODE (CBC_ARRAY_APPEND, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_FALSE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK)) \
  CBC_OPCODE (CBC_PUSH_ELISION, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_STRICT_EQUAL, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_RIGHT_OPERAND_VALUE(VM_OC_OP_STACK)) \
  \
  /* Basic opcodes. */ \
