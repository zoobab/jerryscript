...
#define CBC_BINARY_LVALUE_OPERATION(name, group) \
  ...
  CBC_OPCODE (name ## _IDENT, CBC_HAS_LITERAL_ARG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_SET_IDENT)) \
  CBC_OPCODE (name ## _LITERAL_IDENT, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 0, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_LITERAL) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_SET_IDENT)) \
...
#define CBC_OPCODE_LIST \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_TRUE_FORWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_TRUE)) \
  CBC_OPCODE (CBC_RETURN, CBC_NO_FLAG, -1, VM_OC_GROUP_VALUE(VM_OC_GROUP_RET) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_BACKWARD_BRANCH (CBC_BRANCH_IF_TRUE_BACKWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_TRUE)) \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_FALSE_FORWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_FALSE)) \
  CBC_OPCODE (CBC_CREATE_OBJECT, CBC_NO_FLAG, 1, VM_OC_GROUP_NONE) \
  CBC_BACKWARD_BRANCH (CBC_BRANCH_IF_FALSE_BACKWARD, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_FALSE)) \
  ...
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_TRUE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_TRUE_LOGICAL)) \
  CBC_OPCODE (CBC_ARRAY_APPEND, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_GROUP_NONE) \
  CBC_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_FALSE, -1, VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_GROUP_VALUE(VM_OC_GROUP_BRANCH_IF_FALSE_LOGICAL)) \
  ...
  CBC_OPCODE (CBC_PUSH_UNDEFINED, CBC_NO_FLAG, 1, VM_OC_GROUP_PUSH_UNDEFINED | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (CBC_PUSH_TRUE, CBC_NO_FLAG, 1, VM_OC_GROUP_PUSH_TRUE | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (CBC_PUSH_FALSE, CBC_NO_FLAG, 1, VM_OC_GROUP_PUSH_FALSE | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (CBC_PUSH_NULL, CBC_NO_FLAG, 1, VM_OC_GROUP_PUSH_NULL | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (CBC_PUSH_THIS, CBC_NO_FLAG, 1, VM_OC_GROUP_PUSH_THIS | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (CBC_PROP_GET, CBC_NO_FLAG, -1, VM_OC_GROUP_NONE) \
  CBC_OPCODE (CBC_PROP_LITERAL_GET, CBC_HAS_LITERAL_ARG, 0, VM_OC_GROUP_NONE) \
