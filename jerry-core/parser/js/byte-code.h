...
#define CBC_UNARY_OPERATION(name, group) \
  CBC_OPCODE (name, CBC_NO_FLAG, 0, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_STACK) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT)) \
  CBC_OPCODE (name ## _LITERAL, CBC_HAS_LITERAL_ARG, 1, VM_OC_GROUP_VALUE(VM_OC_GROUP_ ## group) | VM_OC_LEFT_OPERAND_VALUE(VM_OC_OP_LITERAL) | VM_OC_POST_PROCESS_VALUE(VM_OC_POST_PUSH_RESULT))
...
#define CBC_OPCODE_LIST \
  ...
  CBC_UNARY_OPERATION (CBC_BIT_NOT, COMPLEMENT) \
