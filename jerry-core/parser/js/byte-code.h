...
#define CBC_NO_RESULT_ASSIGNMENT(opcode) \
  ((opcode) >= CBC_ASSIGN && (opcode) < CBC_ASSIGN_ADD)
...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_RETURN, CBC_NO_FLAG, -1, VM_OC_RET | VM_OC_PUT_STACK) \
  CBC_BACKWARD_BRANCH (CBC_BRANCH_IF_TRUE_BACKWARD, -1, VM_OC_BRANCH_IF_TRUE | VM_OC_GET_STACK) \
  CBC_OPCODE (CBC_RETURN_WITH_UNDEFINED, CBC_NO_FLAG, 0, VM_OC_RET | VM_OC_PUT_STACK) \
  ...
  CBC_OPCODE (CBC_ASSIGN_RESOLVE_LITERAL, CBC_HAS_LITERAL_ARG, 3, VM_OC_NONE) \
  CBC_OPCODE (CBC_ASSIGN_PROP_GET, CBC_NO_FLAG, 1, VM_OC_NONE) \
  CBC_OPCODE (CBC_ASSIGN_PROP_LITERAL_GET, CBC_HAS_LITERAL_ARG, 2, VM_OC_NONE) \
  CBC_OPCODE (CBC_NEW, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_NONE) \
  CBC_OPCODE (CBC_NEW_IDENT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 1, VM_OC_NONE) \
  ...
  CBC_OPCODE (CBC_CALL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_CALL) \
  CBC_OPCODE (CBC_CALL_IDENT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_CALL) \
  CBC_OPCODE (CBC_CALL_IDENT_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 1, VM_OC_CALL | VM_OC_GET_LITERAL_BYTE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL_PROP, CBC_HAS_POP_STACK_BYTE_ARG, -2, VM_OC_CALL) \
  CBC_OPCODE (CBC_CALL_PROP_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_CALL) \
  CBC_OPCODE (CBC_CALL_PROP_LITERAL, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_CALL) \
  CBC_OPCODE (CBC_CALL_PROP_LITERAL_PUSH_RESULT, CBC_HAS_LITERAL_ARG | CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_CALL) \
  \
...
#define CBC_EXT_OPCODE_LIST \
  ...
  \
  /* Call opcodes. */ \
  CBC_OPCODE (CBC_EXT_CALL_EVAL, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_NONE) \
  CBC_OPCODE (CBC_EXT_CALL_EVAL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 1, VM_OC_NONE) \
  \
