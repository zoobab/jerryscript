...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_TYPEOF_LITERAL, CBC_HAS_LITERAL_ARG, 1, VM_OC_TYPEOF_IDENT | VM_OC_PUT_STACK) \
  \
  /* Binary opcodes. */ \
  ...
  CBC_OPCODE (CBC_CALL_EVAL, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_EVAL | VM_OC_GET_BYTE) \
  CBC_OPCODE (CBC_CALL_EVAL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 0, VM_OC_EVAL | VM_OC_GET_BYTE | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_CALL_EVAL_BLOCK, CBC_HAS_POP_STACK_BYTE_ARG, -1, VM_OC_EVAL | VM_OC_GET_BYTE | VM_OC_PUT_BLOCK) \
